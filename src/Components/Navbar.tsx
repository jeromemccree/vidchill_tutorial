        ...
        <>
          <div className=" mx-auto  max-w-full  px-6 sm:px-6 lg:px-16">
            <div className="flex justify-between  lg:gap-8 xl:grid xl:grid-cols-12">
              ...
              <div className="w-full min-w-0 flex-1  md:px-8 lg:px-0 xl:col-span-8">
                <div className=" flex items-center px-6 py-4 md:mx-auto md:max-w-lg lg:mx-0 lg:max-w-none xl:mx-0 xl:px-0">
